...
public class NNSA {
    ...
    public static void main(String[] args) {
        ...
        final_result += "iters,f,cooling,accuracy,optimtime,testtime\n";
        init_output_file();
        //make CV folds
        int foldsize = 5;
        ...
        for(int f=0 ; f<5; f++ ) {
            ...
            for(int q=0; q<coolings.length; q++) {
                oa = new SimulatedAnnealing(1E11, coolings[q], nnop);
                results = "";
                ...
                for(int iter=0; iter<iterations.length; iter++) {
                    ...
                    final_result += (iterations[iter] + "," + f + "," + coolings[q] + "," + df.format(correct / (correct + incorrect) * 100)
